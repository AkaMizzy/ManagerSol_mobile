...
export function CustomTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  return (
    <View style={[
      ...
      {state.routes.filter(r => r.name !== 'profile' && r.name !== 'index' && r.name !== 'tasks' && r.name !== 'qualiphoto' && r.name !== 'planning' && r.name !== 'change-password' && r.name !== 'edit-zone-plan').map((route, index) => {
